    ...
    <main style={{ background: "#000", minHeight: "100vh", color: "#fff" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "stretch" }}>
                    ...
                    <div style={{ flex: 1, padding: "16px 18px", minWidth: 0 }}>
                      ...
                      <div style={{
                        ...
                        {b.venue_price && (
                          <div style={{
                            fontSize: "14px", fontWeight: 800, color: "#22c55e", marginLeft: "auto",
                          }}>
                            {Number(b.venue_price).toLocaleString()} <span style={{ fontSize: "11px", color: "rgba(255,255,255,0.3)", fontWeight: 400 }}>so&apos;m</span>
                          </div>
                        )}
                      </div>
                      ...
                      {/* Cancel button */}
                      {dispStatus === "upcoming" && (
                        <div style={{ marginTop: "12px", paddingTop: "12px", borderTop: "1px solid rgba(255,255,255,0.05)", display: "flex", gap: "8px" }}>
                          <Link href={`/venues/${b.venue}`} style={{
                          ...
                          <button onClick={() => handleCancel(b.id)} disabled={cancellingId === b.id} style={{
                            ...
                            transition: "all .15s", opacity: cancellingId === b.id ? 0.6 : 1,
                          }}>
                            {cancellingId === b.id ? (
                              <><span style={{
                                width: "12px", height: "12px", borderRadius: "50%",
                                border: "1.5px solid rgba(239,68,68,0.3)", borderTopColor: "#ef4444",
      ...
      {toast && (
        <div style={{
          ...
          background: "#111", border: `1px solid ${toast.type === "success" ? "rgba(34,197,94,0.3)" : "rgba(239,68,68,0.3)"}`,
