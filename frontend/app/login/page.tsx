      ...
      <div style={{ width: "100%", maxWidth: "420px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: "22px" }}>
            <h1 style={{ fontSize: "22px", fontWeight: 800, color: "#fff", letterSpacing: "-0.02em", marginBottom: "6px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            ...
            {!isLogin && (
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
                <div>
                  <label style={{ display: "block", fontSize: "11px", fontWeight: 700, color: "rgba(255,255,255,0.4)", marginBottom: "6px", textTransform: "uppercase", letterSpacing: ".05em" }}>
                    Ism *
                  </label>
                  <input value={firstName} onChange={e => setFirstName(e.target.value)}
                    placeholder="Ziyobek" style={inputStyle(!!fieldErrors.firstName)}
                  />
                  {fieldErrors.firstName && <p style={{ fontSize: "11px", color: "#ef4444", marginTop: "4px" }}>{fieldErrors.firstName}</p>}
                </div>
                <div>
                  <label style={{ display: "block", fontSize: "11px", fontWeight: 700, color: "rgba(255,255,255,0.4)", marginBottom: "6px", textTransform: "uppercase", letterSpacing: ".05em" }}>
                    Familiya *
                  ...
                  />
                  {fieldErrors.lastName && <p style={{ fontSize: "11px", color: "#ef4444", marginTop: "4px" }}>{fieldErrors.lastName}</p>}
                </div>
              </div>
            )}
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <span style={{ position: "absolute", left: "13px", top: "50%", transform: "translateY(-50%)", fontSize: "15px", opacity: 0.35 }}>👤</span>
              ...
              {fieldErrors.username && <p style={{ fontSize: "11px", color: "#ef4444", marginTop: "4px" }}>{fieldErrors.username}</p>}
            </div>
            ...
            {!isLogin && (
              <>
                <div>
                  <label style={{ display: "block", fontSize: "11px", fontWeight: 700, color: "rgba(255,255,255,0.4)", marginBottom: "6px", textTransform: "uppercase", letterSpacing: ".05em" }}>
                    Email <span style={{ color: "rgba(255,255,255,0.2)", fontWeight: 400, textTransform: "none" }}>(ixtiyoriy)</span>
                  </label>
                  <div style={{ position: "relative" }}>
                    <span style={{ position: "absolute", left: "13px", top: "50%", transform: "translateY(-50%)", fontSize: "15px", opacity: 0.35 }}>✉️</span>
                  ...
                  {fieldErrors.email && <p style={{ fontSize: "11px", color: "#ef4444", marginTop: "4px" }}>{fieldErrors.email}</p>}
                </div>
                <div>
                  <label style={{ display: "block", fontSize: "11px", fontWeight: 700, color: "rgba(255,255,255,0.4)", marginBottom: "6px", textTransform: "uppercase", letterSpacing: ".05em" }}>
                    Telefon <span style={{ color: "rgba(255,255,255,0.2)", fontWeight: 400, textTransform: "none" }}>(ixtiyoriy)</span>
                  </label>
                  <div style={{ position: "relative" }}>
                    <span style={{ position: "absolute", left: "13px", top: "50%", transform: "translateY(-50%)", fontSize: "15px", opacity: 0.35 }}>📱</span>
                  ...
                  {fieldErrors.phone && <p style={{ fontSize: "11px", color: "#ef4444", marginTop: "4px" }}>{fieldErrors.phone}</p>}
                </div>
              </>
            )}
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "6px" }}>
                <label style={{ fontSize: "11px", fontWeight: 700, color: "rgba(255,255,255,0.4)", textTransform: "uppercase", letterSpacing: ".05em" }}>
                  Parol *
                </label>
                {isLogin && (
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  style={{ ...inputStyle(!!fieldErrors.password), paddingLeft: "38px", paddingRight: "40px" }}
              ...
              {fieldErrors.password && <p style={{ fontSize: "11px", color: "#ef4444", marginTop: "4px" }}>{fieldErrors.password}</p>}
              ...
              <div>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input
                    ...
                    value={password2}
                    onChange={e => { setPassword2(e.target.value); setFieldErrors(f => ({...f, password2:""})); }}
                ...
                {fieldErrors.password2 ? (
                  <p style={{ fontSize: "11px", color: "#ef4444", marginTop: "4px" }}>{fieldErrors.password2}</p>
                ) : password2.length > 0 && !passwordsMatch ? (
                  <p style={{ fontSize: "11px", color: "#ef4444", marginTop: "4px" }}>Parollar mos kelmadi</p>
                ) : password2.length > 0 && passwordsMatch ? (
                  <p style={{ fontSize: "11px", color: "#22c55e", marginTop: "4px" }}>✓ Parollar mos keldi</p>
                ) : null}
              </div>
            )}
          </div>
          ...
          <button
            ...
            style={{
              ...
              color: "#fff", fontSize: "14px", fontWeight: 700, letterSpacing: ".01em",
          ...
          <p style={{ textAlign: "center", fontSize: "13px", color: "rgba(255,255,255,0.3)" }}>
            ...
            <button onClick={() => { setIsLogin(!isLogin); reset(); }} style={{
